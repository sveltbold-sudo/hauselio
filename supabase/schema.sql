...
CREATE INDEX IF NOT EXISTS "Product_isPromo_idx" ON "Product"("isPromo");
...
CREATE INDEX IF NOT EXISTS "Product_categoryId_isFeatured_idx" ON "Product"("categoryId", "isFeatured");
CREATE INDEX IF NOT EXISTS "Product_categoryId_isNew_idx" ON "Product"("categoryId", "isNew");
CREATE INDEX IF NOT EXISTS "Product_categoryId_isPromo_idx" ON "Product"("categoryId", "isPromo");
...
CREATE UNIQUE INDEX IF NOT EXISTS "Review_productId_authorEmail_key" ON "Review"("productId", "authorEmail");
CREATE UNIQUE INDEX IF NOT EXISTS "Newsletter_email_key" ON "Newsletter"("email");
CREATE INDEX IF NOT EXISTS "Newsletter_isActive_idx" ON "Newsletter"("isActive");

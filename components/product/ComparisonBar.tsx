...
export default function ComparisonBar() {
  ...
  return (
    <div className={`fixed bottom-14 lg:bottom-0 left-0 right-0 z-[70] bg-white border-t border-[var(--color-border)] shadow-[0_-4px_20px_rgba(0,0,0,0.1)] ${prefersReduced ? "" : "transform transition-transform duration-300"}`} style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }} role="region" aria-label="Produktvergleich">

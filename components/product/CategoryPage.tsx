  ...
  return (
    <div className="container-hausaura py-6 sm:py-8 lg:py-10">
      ...
      <Suspense fallback={<div className="h-12 bg-[var(--color-bg-secondary)] rounded-xl animate-pulse" />}>
        <div className="sticky top-20 z-30 flex flex-row items-center justify-between gap-2 sm:gap-4 mb-6 bg-white/95 backdrop-blur-sm rounded-xl border border-[var(--color-border-light)] px-3 sm:px-5 py-2 sm:py-3 shadow-sm">
      ...
      {products.length === 0 ? (
        ...
        <>
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-5 auto-rows-[1fr]">

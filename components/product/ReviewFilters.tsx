      ...
      <div className="flex items-center justify-between bg-[var(--color-bg)] rounded-xl p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-sm border-0 bg-transparent font-medium text-[var(--color-text-secondary)] min-h-[44px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] rounded-lg cursor-pointer"
          >

...
export default function ShopFilterDrawer({
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block w-64 flex-shrink-0 sticky top-24 max-h-[calc(100vh-8rem)] overflow-y-auto" aria-label="Produktfilter">
        <ShopFilters

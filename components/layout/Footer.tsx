          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-colors duration-250"
              >
              ...
              <a
                href="https://www.facebook.com/hauselio"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="HAUSELIO auf Facebook"
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 transition-colors duration-250"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">

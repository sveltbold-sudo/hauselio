...
export default function MiniCart() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div ref={dropdownRef} className="absolute right-0 top-full mt-2 w-[calc(100dvw-2rem)] sm:w-[380px] bg-white rounded-2xl shadow-[var(--shadow-2xl)] border border-[var(--color-border-light)] z-50 animate-scale-in origin-top-right" role="dialog" aria-modal="true" aria-label="Warenkorb">
          {/* Header */}

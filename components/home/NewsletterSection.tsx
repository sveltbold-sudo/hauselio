        ...
        {isSubscribed ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2.5 max-w-md mx-auto">
            ...
            <input
              ...
              className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-white/40 focus:bg-white/15 transition-colors duration-200 text-sm"
            />
            <button
              type="submit"

...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center font-semibold rounded-xl transition-colors transition-shadow transition-transform duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:focus-visible:ring-0 active:scale-[0.97] motion-reduce:scale-100 select-none";
    ...
    const variants = {
      ...
      gradient:
        "bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-primary-hover)] text-white hover:brightness-110 focus-visible:ring-[var(--color-primary)] shadow-lg shadow-[var(--color-primary)]/20 hover:shadow-[var(--color-primary)]/30 hover:shadow-xl",
      secondary:

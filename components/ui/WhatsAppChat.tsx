...
export default function WhatsAppChat() {
  ...
  return (
    <div className={`fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-[80] flex flex-col items-end gap-3 ${prefersReduced ? "" : "animate-in fade-in slide-in-from-bottom-4 duration-300"}`}>
      {/* Tooltip */}

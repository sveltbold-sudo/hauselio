      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Features */}
            <div className="bg-white rounded-xl border border-[var(--color-border-light)] p-6">
              <h2 className="font-bold text-[var(--color-text-primary)] mb-4">Features</h2>
            ...
            {/* Technische Daten */}
            <div className="bg-white rounded-xl border border-[var(--color-border-light)] p-6">
              <h2 className="font-bold text-[var(--color-text-primary)] mb-4">Technische Daten</h2>
              <div className="flex gap-2 mb-3">
                <input
                  type="text"
                  value={formData.newSpecKey}
                  onChange={(e) => setFormData((prev) => ({ ...prev, newSpecKey: e.target.value }))}
                ...
                <input
                  ...
                  onChange={(e) => setFormData((prev) => ({ ...prev, newSpecValue: e.target.value }))}
                  ...
                  <tbody>
                    {formData.specs.map((spec, i) => (
                      <tr key={i} className="border-b border-[var(--color-border-light)] last:border-0">
                        <td className="py-2 text-sm font-medium text-[var(--color-text-primary)]">{spec.key}</td>
                        <td className="py-2 text-sm text-[var(--color-text-secondary)]">{spec.value}</td>
                        <td className="py-2 text-right">
                          <button type="button" onClick={() => removeSpec(i)} className="text-red-500 hover:text-red-700">
                            <X className="w-4 h-4" />
                          </button>
                        </td>
                      </tr>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-[var(--color-border-light)] p-6">
              <h2 className="font-bold text-[var(--color-text-primary)] mb-4">Preise & Verfügbarkeit</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Preis (EUR) *</label>
                  <input
                    type="number"
                    step="0.01"
                    required
                ...
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Originalpreis (EUR)</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Gewicht (kg)</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => setFormData((prev) => ({ ...prev, inStock: e.target.checked ? "true" : "false" }))}
                      className="rounded border-gray-300 text-[var(--color-accent)] focus:ring-[var(--color-accent)]"
                    />
                    <span className="text-sm text-[var(--color-text-secondary)]">Verfügbar</span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      checked={formData.isNew === "true"}
                      onChange={(e) => setFormData((prev) => ({ ...prev, isNew: e.target.checked ? "true" : "false" }))}
                      className="rounded border-gray-300 text-[var(--color-accent)] focus:ring-[var(--color-accent)]"
                    />
                    <span className="text-sm text-[var(--color-text-secondary)]">Neu</span>
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      checked={formData.isFeatured === "true"}
                      onChange={(e) => setFormData((prev) => ({ ...prev, isFeatured: e.target.checked ? "true" : "false" }))}
                      className="rounded border-gray-300 text-[var(--color-accent)] focus:ring-[var(--color-accent)]"
                    />
                    <span className="text-sm text-[var(--color-text-secondary)]">Empfohlen</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            {/* Kategorie & Marke */}
            <div className="bg-white rounded-xl border border-[var(--color-border-light)] p-6">
              <h2 className="font-bold text-[var(--color-text-primary)] mb-4">Kategorie & Marke</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Kategorie *</label>
                  <select
                    required
                ...
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Marke</label>
                  <select
            ...
            {/* Bild */}
            <div className="bg-white rounded-xl border border-[var(--color-border-light)] p-6">
              <h2 className="font-bold text-[var(--color-text-primary)] mb-4">Produktbild</h2>
              <ImageUpload
            ...
            {/* SEO */}
            <div className="bg-white rounded-xl border border-[var(--color-border-light)] p-6">
              <h2 className="font-bold text-[var(--color-text-primary)] mb-4">SEO</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Meta Title</label>
                  <input
                    type="text"
                    maxLength={60}
                ...
                <div>
                  <label className="block text-sm font-semibold text-[var(--color-text-primary)] mb-1.5">Meta Description</label>
                  <textarea
                    rows={3}
                    maxLength={160}

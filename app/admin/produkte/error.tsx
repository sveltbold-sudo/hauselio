...
export default function ProdukteError({
  ...
  useEffect(() => {
    console.error("[HAUSELIO] Produkte error:", error);
  }, [error]);
  ...
  return (
    <div className="p-8 text-center">
      ...
      <h2 className="text-lg font-bold text-gray-900 mb-2">Fehler bei den Produkten</h2>
      <p className="text-gray-500 mb-6">Die Produktliste konnte nicht geladen werden.</p>

  ...
  return (
    <main id="main-content" className="container-hauselio py-8" role="status" aria-label="Wird geladen">
      <div className="animate-pulse">
        {/* Header skeleton */}
        <div className="mb-10">
          <div className="h-3 w-24 bg-[var(--color-bg-secondary)] rounded mb-4" />
          <div className="h-8 w-48 bg-[var(--color-bg-secondary)] rounded mb-2" />
          <div className="h-4 w-96 bg-[var(--color-bg-secondary)] rounded" />
        </div>
          ...
          {[...Array(6)].map((_, i) => (
            ...
            >
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="h-6 w-24 bg-[var(--color-bg-secondary)] rounded" />
              </div>
            </div>
          ))}
        </div>

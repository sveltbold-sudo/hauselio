                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div role="group" aria-label="Artikelmenge" className="flex items-center border border-[var(--color-border)] rounded-xl overflow-hidden">
                    <button
                      ...
                      className="w-11 h-11 flex items-center justify-center text-[var(--color-text-secondary)] hover:bg-[var(--color-bg-secondary)] transition-colors active:scale-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] disabled:opacity-30 disabled:cursor-not-allowed"
                    >
                      -
                    </button>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-[var(--color-border-light)] p-5 sm:p-6 lg:sticky lg:top-24">
            ...
            <p className="text-xs text-center text-[var(--color-text-muted)] mt-3">
              Überweisung (Vorkasse) · Kreditkarte folgt in Kürze
            </p>
            ...
            <div className="mt-4 pt-4 border-t border-[var(--color-border-light)]">
              ...
              <div className="flex flex-wrap gap-2">
                {["Überweisung (Vorkasse)", "Kreditkarte (bald verfügbar)"].map((method) => (
                  <span
                    key={method}

...
if (!adminEmail) {
  ...
  const categories = [
    {
      name: "Küche & Kochen", slug: "kueche",
      description: "Hochwertige Küchengeräte für anspruchsvolle Köche. Von Induktionsherden bis zu Premium-Backöfen.",
      longDescription: "Entdecken Sie unsere erstklassige Auswahl an Küchengeräten, die Ihre Kochkunst auf das nächste Level heben. Von leistungsstarken Induktionsherden und Premium-Backöfen bis hin zu vielseitigen Kochfeldern und Airfryern — bei HAUSAURA finden Sie alles, was das Herz begehrt.\n\nUnsere Küchengeräte stammen von führenden Herstellern wie Bosch, Siemens, Miele und Gaggenau. Jedes Gerät überzeugt durch erstklassige Verarbeitung, energieeffiziente Technologie und modernes Design, das sich perfekt in Ihre Küche einfügt.\n\nBesonders beliebt sind unsere Thermomix-Köche, die mit über 80 Funktionen jedes Kochabenteuer zu einem Erlebnis machen. Für alle, die Wert auf gesundes Kochen legen, bieten unsere Dampfgarer und Airfryer die perfekte Lösung — schonend, fettarm und geschmackvoll.\n\nProfitieren Sie von kostenfreiem Versand ab 50€, 2 Jahre Garantie auf alle Produkte und unserer kompetenten Beratung. Unser Kundenservice steht Ihnen gerne bei Fragen zur Verfügung und hilft Ihnen bei der Auswahl des perfekten Küchengeräts.",
      image: "/images/categories/kueche.jpg", sortOrder: 0,
    },
    {
      name: "Kaffee", slug: "kaffee",
      description: "Premium Kaffeemaschinen für den perfekten Genuss. Vollautomaten, Espresso-Maschinen und Filterkaffee.",
      longDescription: "Der perfekte Kaffee beginnt mit der richtigen Maschine. Bei HAUSAURA finden Sie eine große Auswahl an Kaffeevollautomaten, Espressomaschinen und Kapselmaschinen von Top-Marken wie Jura, De'Longhi, Siemens und Nespresso.\n\nKaffeevollautomaten sind die beliebteste Wahl für Kaffeeliebhaber, die Wert auf Frische und Qualität legen. Mit einer Mahlwerk aus Edelstahl und integriertem Milchsystem zaubern Sie sich jeden Tag ein Café-Erlebnis zuhause. Von der Crema bis zur Brühgruppe — ogni Detail zählt.\n\nFür Liebhaber italienischen Espressos empfehlen wir unsere Siebträgermaschinen von Breville und Sage. Diese Geräte bieten professionelle Brühdruck-Technologie und latte art-fähige Milchaufschäumer.\n\nPraktisch und platzsparend: Kapselmaschinen von Nespresso und Tchibo liefern in Sekunden einen aromatischen Kaffee — ideal für den schnellen Genuss zwischen durch.\n\nAlle unsere Kaffeemaschinen werden mit 2 Jahre Garantie geliefert. Kostenloser Versand ab 50€ Bestellwert. Finden Sie jetzt Ihre perfekte Kaffeemaschine bei HAUSAURA.",
      image: "/images/categories/kaffee.jpg", sortOrder: 1,
    },
    {
      name: "Reinigung", slug: "reinigung",
      description: "Effiziente Reinigungsgeräte für Ihr Zuhause. Staubsauger, Saugroboter und Dampfreiniger.",
      longDescription: "Sauberkeit und Hygiene sind die Grundlage für ein wohliges Zuhause. Bei HAUSAURA finden Sie eine umfassende Auswahl an hochwertigen Reinigungsgeräten, die jede Reinigungssituation meistern — vom schnellen Saugroboter-Turn bis zur gründlichen Nass- und Trockensauger-Reinigung.\n\nStaubsauger von Bosch, Siemens und Dyson überzeugen durch starke Saugleistung, HEPA-Filterung und leises Arbeiten. Ob kabellos oder mit Kabel, für Teppiche oder Hartböde — wir haben den passenden Staubsauger für Ihren Bedarf.\n\nSaugroboter von iRobot, Roborock und Xiaomi übernehmen die Reinigung komplett automatisch. Mit App-Steuerung, Kartennavigation und automatischer Staubbasis reinigen diese intelligenten Helfer Ihr Zuhause, während Sie nicht da sind.\n\nGeschirrspüler von Bosch und Siemens sparen Wasser und Energie, während sie Ihr Geschirr makellos sauber machen. Die neuesten Modelle mit Zeolith-Trocknung bieten die beste Trocknungsleistung auf dem Markt.\n\nFür die gründliche Vertikalreinigung empfehlen wir unsere Dampfreiniger von Kärcher und Tefal — ideal für Fliesen, Fugen und empfindliche Oberflächen.\n\nKostenloser Versand ab 50€. 2 Jahre Garantie auf alle Reinigungsgeräte.",
      image: "/images/categories/reinigung.jpg", sortOrder: 2,
    },
    {
      name: "Klima", slug: "klima",
      description: "Klimaanlagen und Luftreiniger für jedes Raumklima. Heizen, Kühlen und Luftreinigung.",
      longDescription: "Das richtige Raumklima ist essentiell für Wohlbefinden und Gesundheit. Bei HAUSAURA finden Sie eine große Auswahl an mobilen Klimaanlagen, Luftreinigern und Heizstrahlern, die für angenehme Temperaturen und saubere Luft in Ihrem Zuhause sorgen.\n\nMobile Klimaanlagen von Comfee, Midea und Trotec bieten flexible Kühlung für einzelne Räume — ohne aufwändige Installation. Mit Energieeffizienzklasse A++ und leiser Arbeitsweise sind diese Geräte ideal für Schlafzimmer, Wohnzimmer oder Büro.\n\nLuftreiniger von Blueair, Levoit und Dyson filtern Feinstaub, Allergene und Schadstoffe aus der Luft. Besonders für Allergiker und Asthmatiker sind diese Geräte ein wertvoller Beitrag zur Lebensqualität. HEPA-Filter der H13-Klasse entfernen bis zu 99,95% aller Partikel.\n\nFür die kühle Jahreszeit bieten wir energieeffiziente Heizstrahler und Ölradiatoren, die schnell und gleichmäßig Wärme verteilen.\n\nAlle Klimageräte werden mit 2 Jahre Garantie geliefert. Kostenloser Versand ab 50€. Lassen Sie sich von unserem Kundenservice beraten und finden Sie die perfekte Lösung für Ihr Raumklima.",
      image: "/images/categories/klima.jpg", sortOrder: 3,
    },
    {
      name: "Smart Home", slug: "smart-home",
      description: "Intelligente Geräte für ein vernetztes Zuhause. Thermostate, Beleuchtung und Sicherheit.",
      longDescription: "Machen Sie Ihr Zuhause intelligenter mit unseren Smart-Home-Lösungen. Bei HAUSAURA finden Sie eine große Auswahl an vernetzten Geräten, die Ihnen Komfort, Sicherheit und Energieeffizienz bieten — steuerbar per App, Sprache oder automatisiert.\n\nSmart-Thermostate von tado° und Netatmo lernen Ihre Gewohnheiten und heizen nur, wenn Sie es wünschen. Bis zu 30% Heizkosteneinsparung sind möglich — gut für Ihr Portemonnaee und die Umwelt.\n\nBeleuchtungssysteme von Philips Hue und Nanoleaf verwandeln Ihr Zuhause in eine Lichtoase. Millions von Farben, szeneriegesteuerte Lichteffekte und intelligente Automatisierung schaffen die perfekte Atmosphäre für jeden Anlass.\n\nSicherheitssysteme von Ring und Netatmo halten Ihr Zuhause sicher. Videotürklingeln, Überwungskameras und Bewegungsmelder informieren Sie in Echtzeit über Geschehnisse vor Ihrer Tür — direkt auf Ihrem Smartphone.\n\nVernetzen Sie Ihre Geräte miteinander und schaffen Sie automatisierte Abläufe: Lichter, die bei Sonnenuntergang angehen, Heizung, die sich herunterregelt, wenn Sie das Haus verlassen, oder eine Kamera, die aufnimmt, wenn Bewegung erkannt wird.\n\nKostenloser Versand ab 50€. 2 Jahre Garantie auf alle Smart-Home-Produkte. Beraten Sie sich gerne mit unserem Kundenservice zur optimalen Lösung für Ihr Zuhause.",
      image: "/images/categories/smart-home.jpg", sortOrder: 4,
    },
    {
      name: "Haushaltsgeräte", slug: "haushaltsgeraete",
      description: "Waschmaschinen, Trockner, Kühlschränke, Geschirrspüler und mehr für den täglichen Bedarf.",
      longDescription: "Zuverlässige Haushaltsgeräte sind das Rückgrat eines gut funktionierenden Haushalts. Bei HAUSAURA finden Sie eine umfassende Auswahl an hochwertigen Waschtrocknern, Kühlschränken, Gefrierschränken und weiteren Geräten für den täglichen Bedarf — alles von renommierten Herstellern.\n\nWaschmaschinen von Bosch, Siemens und Miele überzeugen durch schonendes Waschen, energieeffiziente Technologie und leise Arbeitsweise. Die neuesten Modelle mit Dosierautomatik und Trommelreinigungsfunktion sorgen für optimale Ergebnisse bei minimalem Wasserverbrauch.\n\nKühlschränke und Gefrierschränke von Liebherr, Samsung und LG bieten großzügigen Stauraum und modernste Kühltechnologie. NoFrost-Technologie, BioFresh-Fächer und energieeffiziente Inverter-Kompressoren halten Ihre Lebensmittel frisch und sparen Energie.\n\nGeschirrspüler von Bosch und Siemens sind die perfekte Lösung für sparsame und gründliche Reinigung. Mit 60cm oder 45cm Breite passen sie in jede Küche und sparen bis zu 50% Wasser im Vergleich zum Spülen von Hand.\n\nTrockner von Bosch, Siemens und Miele runden Ihre Wäscheversorgung ab. Wärmepumpentrockner sind besonders energieeffizient und schonen Ihre Kleidung.\n\nKostenloser Versand ab 50€. 2 Jahre Garantie auf alle Haushaltsgeräte. Kompetente Beratung durch unseren Kundenservice.",
      image: "/images/categories/haushaltsgeraete.jpg", sortOrder: 5,
    },
  ];
...
async function main() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      avatar: "/images/testimonials/klaus.jpg",
      isApproved: true,
      isFeatured: false,
    },
    {
      ...
      avatar: "/images/testimonials/monika.jpg",
      isApproved: true,
      isFeatured: false,
    },
    {
    ...
    },
    {
      ...
      avatar: "/images/testimonials/christine.jpg",
      isApproved: true,
      isFeatured: false,
    },
  ];

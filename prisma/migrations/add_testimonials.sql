...
VALUES
    ...
    ('clt1a00010000000000000002', 'Anna K.', 'München', 5, 'Die Miele Waschmaschine wurde problemlos geliefert. Das Gerät läuft super und der Preis war am günstigsten. Vielen Dank!', 'Miele W1 Waschmaschine', true, true, NOW(), NOW()),
    ...
    ('clt1a00010000000000000004', 'Julia H.', 'Köln', 5, 'Die KitchenAid Artisan kommt genau wie beschrieben. Der Versand war schnell und das Gerät ist wunderschön. Gerne wieder!', 'KitchenAid Artisan', true, true, NOW(), NOW()),
    ...
    ('clt1a00010000000000000008', 'Sandra L.', 'Leipzig', 5, 'Tolle Beratung beim Kauf der Miele Spülmaschine. Alles super gelaufen, gerne wieder!', 'Miele G 7310 SCU', true, false, NOW(), NOW()),
    ...
    ('clt1a00010000000000000010', 'Monika F.', 'Hannover', 5, 'Schnelle Lieferung und gutes Preis-Leistungs-Verhältnis. Die Bosch Spülmaschine läuft einwandfrei. Danke!', 'Bosch SMS4HVW00E', true, false, NOW(), NOW()),
